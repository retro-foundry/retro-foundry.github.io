...
// include: C:\Users\paula\AppData\Local\Temp\tmp7_tn1vmn.js
...
Module['FS_createPath']("/data/Tracks", "Original", true, true);
Module['FS_createPath']("/data/Tracks", "TNT", true, true);
...
// include: C:\Users\paula\AppData\Local\Temp\tmp_a4l157r.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\paula\AppData\Local\Temp\tmp_a4l157r.js
...
var _SetWebKeyboardKey = Module['_SetWebKeyboardKey'] = makeInvalidEarlyAccess('_SetWebKeyboardKey');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['SetWebKeyboardKey'] != 'undefined', 'missing Wasm export: SetWebKeyboardKey');
  ...
  _SetWebKeyboardKey = Module['_SetWebKeyboardKey'] = createExportWrapper('SetWebKeyboardKey', 2);
